            ...
            <div className="flex-1 flex flex-col">
                ...
                >
                        ...
                        <form className="space-y-6">
                            ...
                            <div>
                                ...
                                <input
                                    type="text"
                                    className="w-full border-b border-gray-400 focus:outline-none focus:border-black bg-transparent"
                                    placeholder="Enter position contested"
                                />
                            </div>
                            <div>
                                <label className="block text-sm font-semibold mb-1">
                    ...
                    <div className="flex justify-end w-11/12 max-w-4xl">
                        <button className="flex items-right bg-black text-white font-semibold rounded-full px-6 py-2 hover:bg-gray-300 hover:text-black transition mt-4 mb-4">
                            Confirm
                            <div className="ml-2">
