        ...
        <div className="min-h-screen flex bg-black text-white ">
            ...
            <div className="flex-1 flex flex-col ">
                ...
                <div className="flex flex-col justify-center items-center relative flex-grow bg-bgColor bg-cover bg-center ml-32">
                    {/* Form Container */}
                    <h2 className="text-xl text-black font-bold mt-4 text-left w-11/12 max-w-4xl">Register Voter</h2>
                    <div className="bg-registerForm text-black rounded-lg shadow-lg p-8 w-11/12 max-w-4xl mt-6">
                        {/* Form Fields */}
                        <form className="space-y-6">
                            <div>
                                <label className="block text-sm font-semibold mb-1">Name of the Voter</label>
                                <input type="text" className="w-full border-b border-gray-400 focus:outline-none focus:border-black bg-transparent" placeholder="Enter voter's name" />
                            </div>
                            <div>
